...
export default function UploadPage() {
  ...
  // When project changes: reset contract + provider
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="rounded-2xl overflow-hidden" style={{ background:'#FFFFFF', border:'1px solid #E2E8F0' }}>
            ...
            <div className="p-6">
              ...
              <button onClick={handleScan} disabled={!file||scanning} className="w-full py-3 rounded-xl text-sm font-semibold disabled:opacity-40 transition-all flex items-center justify-center gap-2" style={{ background:'#3B82F6',color:'#fff' }}>
                {scanning?(
          ...
          {/* Link panel: Project → Contract → Provider → Tranche */}
          <div className="rounded-2xl overflow-hidden" style={{ background:'#FFFFFF', border:'1px solid #E2E8F0' }}>
