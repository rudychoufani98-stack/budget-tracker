  ...
  return (
    <div className="px-6 py-8 max-w-5xl mx-auto">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-medium" style={{ color:'#F9FAFB' }}>Upload Invoice</h1>
      </div>
      ...
      {step === 1 && (
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="rounded-2xl p-6" style={{ background:C.card, border:`1px solid ${C.border}` }}>
            <p className="text-sm font-medium mb-4" style={{ color:'#F9FAFB' }}>Link to Contract</p>
      ...
      {step === 2 && scanned && (
        <div className="grid grid-cols-2 gap-6">
          <div className="space-y-5">
            <div className="rounded-2xl p-6" style={{ background:C.card, border:`1px solid ${C.border}` }}>
              <div className="flex items-center justify-between mb-5">
                <p className="text-sm font-medium" style={{ color:'#F9FAFB' }}>Extracted Data</p>
          ...
          <div className="rounded-2xl p-5" style={{ background:C.card, border:`1px solid ${C.border}` }}>
            <p className="text-sm font-medium mb-3" style={{ color:'#F9FAFB' }}>Summary</p>
            <div className="space-y-2.5">
              {[
                ...
                <div key={r.label} className="flex justify-between text-sm">
                  ...
                  <span style={{ color:'#F9FAFB' }}>{r.value}</span>
                </div>
              ))}
              <div className="flex justify-between pt-3" style={{ borderTop:`1px solid ${C.border}` }}>
                <span className="text-sm font-medium" style={{ color:'#F9FAFB' }}>Total TTC</span>
              ...
              <div className="mt-4">
                ...
                {scanned.line_items.slice(0,5).map((li,i)=>(
                  <div key={i} className="flex justify-between text-xs py-1.5" style={{ borderBottom:`1px solid ${C.border}` }}>
                    <span className="truncate mr-4" style={{ color:'#D1D5DB' }}>{li.description||'—'}</span>
      ...
      {step === 3 && (
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <h2 className="text-xl font-medium mb-2" style={{ color:'#F9FAFB' }}>Invoice Submitted!</h2>
