      ...
      <div className="hidden lg:flex flex-col justify-between w-2/5 p-12" style={{ background: 'linear-gradient(160deg,#0F172A 0%,#1E3A5F 100%)' }}>
        ...
        <div>
          <h2 className="text-3xl font-bold mb-4 leading-tight" style={{ color: '#fff' }}>
            Secure Internal<br />Management Portal
          </h2>
          ...
          <div className="flex flex-col gap-3">
            {[
              ...
              { icon: 'shield',  text: 'Protected by multi-layer security' },
              { icon: 'monitor', text: 'All sessions are monitored' },
            ].map(({ icon, text }) => (
        ...
        <p className="text-xs" style={{ color: 'rgba(255,255,255,0.2)' }}>
          SkyKapital Europe &mdash; Confidential &amp; Proprietary
        </p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="rounded-2xl overflow-hidden shadow-xl" style={{ background: '#FFFFFF' }}>
            ...
            <div className="p-8">
              <h1 className="text-2xl font-bold mb-1" style={{ color: '#0F172A' }}>Sign in</h1>
              <p className="text-sm mb-8" style={{ color: '#64748B' }}>Enter your credentials to continue</p>

              <form onSubmit={handleLogin} className="space-y-5">
                <div>
                  <label className="text-xs font-bold uppercase tracking-widest mb-2 block" style={{ color: '#64748B' }}>Email</label>
                  <input
                    type="email"
                    value={email}
                ...
                <button
                  ...
                  style={{ background: 'linear-gradient(135deg,#1D4ED8,#3B82F6)', color: '#fff', boxShadow: '0 4px 14px rgba(59,130,246,0.35)' }}
                >
                  {loading ? (
